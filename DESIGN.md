...
**Project Context Rail:** Every standalone project page should include only a compact fixed `Back to Portfolio` link. Keep this element lightweight so it helps visitors return to the cover page without covering the project design or adding duplicate portfolio copy.
